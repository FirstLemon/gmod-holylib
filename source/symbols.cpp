...
namespace Symbols
{
	...
	const std::vector<Symbol> GarrysMod_AutoRefresh_HandleChange_LuaSym = {
		...
		Symbol::FromSignature("\x55\x48\x89\xE5\x41\x57\x41\x56\x49\x89\xD6\x41\x55\x49\x89\xFD\x48\x89\xD7\x41\x54"), // 55 48 89 E5 41 57 31 56 49 89 D6 41 55 49 89 FD 48 89 D7 31 54
		NULL_SIGNATURE,
		NULL_SIGNATURE,
	};
